...
def parse_to_2d2tuple_list(query_result, label11, label12, label21, label22):
    result_as_list = []
    for record in query_result:
        result_as_list.append(((record[label11], record[label12]), (record[label21], record[label22])))
    return result_as_list
